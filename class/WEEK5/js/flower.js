class Flower {
    constructor() { // functions inside a class do not need "function"
        // Position and size information
        // prefix properties, preparing fro when thr flower exists
        this.x = Math.random() * (window.innerWidth); // randomize position
      ...
      // Color information
        ...
        let self = this //create local variable called "self"
        
        this.flowerStemDiv.addEventListener("click", growStem)
        function growStem(e) {
            console.log(self) // gives stem length for particular flower
            //console.log(this)
